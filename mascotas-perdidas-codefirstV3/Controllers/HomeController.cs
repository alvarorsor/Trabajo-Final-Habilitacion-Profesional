...
namespace WebApplicationpaypal_1.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<ActionResult> Pago_realizado()
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                var userName = "AWSqOqKgml8dzogKEaGnRxHhYujso1mCT2oI3TzhG4V-5a5LaeOL9wgnmo0GSzFwHAJXUw-9_FkRgFff";
                var passwd = "EOjvhRojAON0H3_XLbLTbiCY62y-sMyrQSWLXujSVyNxaa7BjIhJiDzEBXMDjWaTw3pSVrIgOUs4eCI0";
            ...
            using (var client = new HttpClient())
            {
                ...
                var orden = new PaypalOrder()
                {
                    ...
                    {   
                        ...
                        return_url = "https://localhost:44360/Home/Pago_realizado",// cuando se aprovo la solicitud del cobro
                        cancel_url = "https://localhost:44360/Home/About"// cuando cancela la operacion
                    }
                };
